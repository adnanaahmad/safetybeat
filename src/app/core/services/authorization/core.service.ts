...
export class CoreService {
    ...
    logoutUser() {
        ...
        this.helperService.createSnack(this.translated.MESSAGES.LOGOUT_SUCCESS, this.translated.MESSAGES.LOGOUT_MSG, this.helperService.constants.status.WARNING);
